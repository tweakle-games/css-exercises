...
### Self Check
- Did you properly chain class selectors for each rule? yeeee
- Does the `proportioned` image retain its original square proportions? yeee
- Does the `distorted` image end up looking squished and, well, distorted? yeee
